...
contract ERC20 is Context, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        require(sender != address(uint160(0)), "ERC20: transfer from the zero address");
        require(recipient != address(uint160(0)), "ERC20: transfer to the zero address");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(uint160(0)), "ERC20: mint to the zero address");

        _beforeTokenTransfer(address(uint160(0)), account, amount);
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(uint160(0)), "ERC20: burn from the zero address");

        _beforeTokenTransfer(account, address(uint160(0)), amount);
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        require(owner != address(uint160(0)), "ERC20: approve from the zero address");
        require(spender != address(uint160(0)), "ERC20: approve to the zero address");
